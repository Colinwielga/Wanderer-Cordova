...
var cardList = [
    ...
    new ColinWielgaCards.QualOutcomeCard("{935019DC-C181-4BB1-B49B-A3E0848A1F1C}", "FLASHBACK", "NUETRAL", "Discard this card to have flashback with one or more other player chacters. The CM will decide if the Cloud of Uncertainty should be increased or decreased. ", "25%", "35%"),

    new ColinWielgaCards.QualOutcomeCard("{5F960058-B513-4D9A-A0ED-A0A43C8CBCBD}", "ATLANTYS", "ALIEN ARTIFACT", "Invisibility: Once a day, become invisible and add +10% success during one encounter. ", "",""),
    ...
    new ColinWielgaCards.QualOutcomeCard("{7046335B-224C-4EA5-A862-F853661E27B0}", "ATLANTUS ", "ALIEN ARTIFACT", "Portable force field, one time use per day. ", "20%","60%"),
    ...
    new ColinWielgaCards.QualOutcomeCard("{4DD4A14E-9454-4536-97C2-578FE294E57A}", "COLD WEREBEAR", "ALIEN ARTIFACT", "Your attacks have a slowing effect. ", "6%","40%"),
    ...
    new ColinWielgaCards.QualOutcomeCard("{500B6195-5AC0-4822-8B16-5BCB8AB940C8}", "INSECTOID", "ALIEN ARTIFACT", "You can no longer breathe oxygen, but you can spit acid. ", "6%","44%"),
    new ColinWielgaCards.QualOutcomeCard("{E79A7AC7-01C9-40CA-9C1F-525768D5E54E}", "SUBTERRANEAN INSECTOID", "ALIEN ARTIFACT", "You can see in low light, but you also secrete slime uncontrollably. ", "6%","44%"),
    new ColinWielgaCards.QualOutcomeCard("{F5C171E3-69B3-4BAC-9BDC-04C7C8E8EFEC}", "AVIAN FLYER", "ALIEN ARTIFACT", "A contraption for personal flight. ", "7%","40%"),
    ...
    new ColinWielgaCards.QualOutcomeCard("{7C4EEB81-EECE-475E-971D-8E42F60461DF}", "WEREBEAR", "ALIEN ARTIFACT", "Protection from the elements. ", "4%","60%"),
    ...
    new ColinWielgaCards.QualOutcomeCard("{846352C6-C233-4508-B7C6-73B20B36B9C8}", "AVIAN FIGHTER", "ALIEN ARTIFACT", "Hunting talisman, serves as an extendable spear. ", "5%","45%"),   
    ...
    new ColinWielgaCards.QualOutcomeCard("{F76BC99A-FEFF-40E1-81AB-09CC25D979E0}", "ATLATL", "SPY GADGET", "Works as a grappling hook. ", "7%","40%"),
    ...
    new ColinWielgaCards.QualOutcomeCard("{AC8E6BC9-8C7E-4C23-9CF5-0A053F9CA029}", "MINI FLAMETHROWER", "SPY GADGET", "Requires gas. ", "",""),   
