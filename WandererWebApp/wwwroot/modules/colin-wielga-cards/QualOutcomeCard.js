...
var cardList = [
    ...
    new ColinWielgaCards.QualOutcomeCard("{4EEC15F2-21BB-4821-86FD-5AD9B2C2131D}", "ATLANTAS", "If you fail, increase the Cloud of Uncertainty.", "20%","10%"),
    new ColinWielgaCards.QualOutcomeCard("{7046335B-224C-4EA5-A862-F853661E27B0}", "ATLANTUS", "Discard this card to add 15% uncertainty to an NPC's next roll.", "30%","15%"),
    new ColinWielgaCards.QualOutcomeCard("{2AF06522-6235-4968-A8F3-AFAAA7AF78DC}", "ATLANTOS", "If you succeed, decrease the Cloud of Uncertainty", "40%","20%"),
    ...
    new ColinWielgaCards.QualOutcomeCard("{60A78845-8762-4FDE-A4C0-4F15ACAB0CFF}", "ATLANTES", "+20% success when navigating or searching.", "60%","30%"),
    new ColinWielgaCards.QualOutcomeCard("{0A20CEF3-1EC2-4C28-9030-F58E9B3869E2}", "ATLANTA", "If using rope with this card, -15% Uncertainty", "40%","35%"),
    new ColinWielgaCards.QualOutcomeCard("{5AD1139D-FA32-4A2A-B678-C3466081E7B5}", "ATLANTS", "If you succeed with this card, add 10% chance of success to your next roll.", "20%","40%"),
    new ColinWielgaCards.QualOutcomeCard("{F31F0B29-BDB0-4C7B-9D4E-2A23A9E440EF}", "ATLANTIAN", "Wrong ocean buddy, if you fail this check you must lose an important personal item.", "15%","55%"),
    ...
    new ColinWielgaCards.QualOutcomeCard("{92AC6554-AE63-4779-AAC6-73582A32070C}", "ANARCHIST", "This card cannot be discarded.  All your rolls have +5% chance of success, but everytime you don't succeed increase the Cloud of Uncertainty.", "45%","2%"),
    ...
    new ColinWielgaCards.QualOutcomeCard("{7C4EEB81-EECE-475E-971D-8E42F60461DF}", "ALEPH", "Critical failure is so catastrophic that you accidentally succeed, but take some damage.", "45%","0%"),
    ...
    new ColinWielgaCards.QualOutcomeCard("{4EA9C4D1-87B9-4B60-8487-4EBE2620938B}", "ARTIFACT", "This card cannot be discarded.  Any time you use alien technology increase the Cloud of Uncertainty.", "45%","2%"),
    new ColinWielgaCards.QualOutcomeCard("{4E5372BC-F2F1-4EDC-9345-8B451F5017BD}", "ANTHROMORPH", "If you fail the Rakshasa assume your form.", "45%","3%"),
    new ColinWielgaCards.QualOutcomeCard("{2E441CF5-6FF1-4A4F-A9E4-AC14E3FF59A7}", "APPOLOGIST", "If you are forgiven, decrease the Cloud of Uncertainty.", "45%","4%"),
    new ColinWielgaCards.QualOutcomeCard("{00AB75F2-94CF-4253-8A96-D5BA1498D80E}", "ATTRITION", "If your party has lost a PC, decrease the Cloud of Uncertainty.", "45%","5%"),
    ...
    new ColinWielgaCards.QualOutcomeCard("{046C06DE-2CF1-4017-A647-B2E23E500D1E}", "ANTAGONIST", "Swim with the fishes, draw an additional card if you betray someone.", "45%","9%"),
    
    new ColinWielgaCards.QualOutcomeCard("{15D3D15F-6025-4488-AB1B-85C0E6EF1684}", "EPHEMERAL", "If you fail with this card, all failures count as catastrophic this round.", "40%","20%"),
    new ColinWielgaCards.QualOutcomeCard("{7A554276-8F9F-422F-AAC2-E3CA2B575788}", "CATALYST", "If you succeed, set off a chain reaction of events within reason and increase the Cloud of Uncertainty", "40%","20%"),
    new ColinWielgaCards.QualOutcomeCard("{EE8F0CAB-5873-4530-BC54-014000CE64ED}", "ADONIS", "If you succeed with this card, all success count as ", "40%","20%"),
    new ColinWielgaCards.QualOutcomeCard("{DBDC3767-C275-4838-A472-077D7C162D93}", "DYNASTIC", "Your lineage is blessed, +5% chance of success.", "40%","20%"),
    new ColinWielgaCards.QualOutcomeCard("{AC8E6BC9-8C7E-4C23-9CF5-0A053F9CA029}", "ADVANTAGEOUS", "+10% chance of success if your battlefield position is higher/better.", "40%","20%"),
    new ColinWielgaCards.QualOutcomeCard("{5DF25620-5369-41DE-AD94-DA84CCCD7F34}", "PHYSICS", "Entropy's a b*tch, increase the Cloud of Uncertainty.", "40%","20%"),
    new ColinWielgaCards.QualOutcomeCard("{A8585373-497A-476C-B909-57FEBED9BB3D}", "GENETICIST", "+15% chance of success if using your personal biology with this card.", "40%","20%"),   
    new ColinWielgaCards.QualOutcomeCard("{581CFD80-1B9E-4B86-B3D7-88F8EB1854EB}", "PROPAGANDIST", "Decrease the Cloud of Uncertainty if you successfully lie with this card.", "40%","20%"),
