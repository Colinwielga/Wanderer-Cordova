...
var cardList = [
    new ColinWielgaCards.QualOutcomeCard("{FB637FA0-CC04-4DC3-BAE3-2FFB3B09C959}", "TRUE NUETRAL", "NUETRAL", "Randomly generated certainty, what could go wrong? ", uncertaintyX + "%", successY + "%"), //Card for passing skill checks, PCs should draw up to five  
    ...
    new ColinWielgaCards.QualOutcomeCard("{5F960058-B513-4D9A-A0ED-A0A43C8CBCBD}", "ATLANTYS", "ALIEN ARTIFACT", "Invisibility: Once a day, become invisible and add +10% success for the duration of one encounter. ", "",""),
    ...
    new ColinWielgaCards.QualOutcomeCard("{60A78845-8762-4FDE-A4C0-4F15ACAB0CFF}", "ATLANTES", "ALIEN ARTIFACT", "A phone starts ringing by you, do you answer it? ", "%","%"),
    new ColinWielgaCards.QualOutcomeCard("{7046335B-224C-4EA5-A862-F853661E27B0}", "ATLANTUS ", "ALIEN ARTIFACT", "Portable force field, one time use per day lasts for one action. ", "20%","60%"),
    new ColinWielgaCards.QualOutcomeCard("{5AD1139D-FA32-4A2A-B678-C3466081E7B5}", "ATLANTS", "ALIEN ARTIFACT", "Chemical breath that can put lifeforms to sleep. ", "20%","40%"),
    new ColinWielgaCards.QualOutcomeCard("{4DD4A14E-9454-4536-97C2-578FE294E57A}", "COLD WEREBEAR", "ALIEN ARTIFACT", "Slowing effect on your attacks, but you always go last. ", "6%","40%"),
    new ColinWielgaCards.QualOutcomeCard("{AD4E32EA-5B49-4C72-A06B-BCCFC5EAFF7F}", "ATLANTIAN", "ALIEN ARTIFACT", "Atlantian made remote control drone. ", "5%","50%"),
    new ColinWielgaCards.QualOutcomeCard("{4EEC15F2-21BB-4821-86FD-5AD9B2C2131D}", "ATLANTACE", "ALIEN ARTIFACT", "Whenever you fail, increase the Cloud of Uncertainty. Describe why you can't get rid of this alien object and how it counters a specific human technology. ", "20%","40%"),
    ...
    new ColinWielgaCards.QualOutcomeCard("{AE170BB5-ABC5-4435-A415-DB6D3732404D}", "FUNGAL", "ALIEN ARTIFACT", "Whenever anyone in your party fails, increase the Cloud of Uncertainty. If the Cloud is over 60%, you acquire the understanding of fungal mind control helmets. ", "5%","40%"),
    ...
    new ColinWielgaCards.QualOutcomeCard("{500B6195-5AC0-4822-8B16-5BCB8AB940C8}", "INSECTOID", "ALIEN ARTIFACT", "You can no longer breathe Earth air, but you can spit acid. ", "6%","44%"),
    ...
    new ColinWielgaCards.QualOutcomeCard("{F5C171E3-69B3-4BAC-9BDC-04C7C8E8EFEC}", "AVIAN FLYER", "ALIEN ARTIFACT", "An entity is hunting you for this, a wind-up contraption for personal flight. ", "7%","40%"),
    ...
    new ColinWielgaCards.QualOutcomeCard("{7C4EEB81-EECE-475E-971D-8E42F60461DF}", "WEREBEAR", "ALIEN ARTIFACT", "Pick one, bonus protection from cold or hot elements? ", "4%","60%"),
    new ColinWielgaCards.QualOutcomeCard("{B602D13C-FEC9-471D-A6BC-9BD520CAB607}", "ATLANTAS", "ALIEN ARTIFACT", "Take one extra action if you have the highest initiative, take a hit for each time you have triggered this. ", "20%", "50%"),
    new ColinWielgaCards.QualOutcomeCard("{846352C6-C233-4508-B7C6-73B20B36B9C8}", "AVIAN FIGHTER", "ALIEN ARTIFACT", "Hunting talisman, an extendable light weight spear/club. ", "5%","45%"),   
    ...
    new ColinWielgaCards.QualOutcomeCard("{F76BC99A-FEFF-40E1-81AB-09CC25D979E0}", "ATLATL", "SPY GADGET", "Ropes' best friend, a grappling hook/harpoon thrower. ", "7%","40%"),
    ...
    new ColinWielgaCards.QualOutcomeCard("{7A554276-8F9F-422F-AAC2-E3CA2B575788}", "CATALYST", "SPY GADGET", "A quick DNA comparison testing device. ", "8%","36%"),
    new ColinWielgaCards.QualOutcomeCard("{A8585373-497A-476C-B909-57FEBED9BB3D}", "BELT BUCKLE GUN", "SPY GADGET", "Four barrels, each with its own trigger. ", "",""),   
    new ColinWielgaCards.QualOutcomeCard("{AC8E6BC9-8C7E-4C23-9CF5-0A053F9CA029}", "MINI FLAMETHROWER", "SPY GADGET", "Requires buffet tray heater gas cartidge. ", "",""),   
    new ColinWielgaCards.QualOutcomeCard("{581CFD80-1B9E-4B86-B3D7-88F8EB1854EB}", "PROPAGANDIST", "SPY GADGET", "Universal translator. ", "20%","40%"),
    ...
    new ColinWielgaCards.QualOutcomeCard("{5DF25620-5369-41DE-AD94-DA84CCCD7F34}", "EXPLOSIVE", "SPY GADGET", "Detonator extraordinaire, -10% uncertainty when using explosives. ", "6%","60%"),
    new ColinWielgaCards.QualOutcomeCard("{DBDC3767-C275-4838-A472-077D7C162D93}", "NEURALIZER", "SPY GADGET", "You may attempt to alter memories, if you fail, increase the Cloud of Uncertainty. ", "40%","20%"),
