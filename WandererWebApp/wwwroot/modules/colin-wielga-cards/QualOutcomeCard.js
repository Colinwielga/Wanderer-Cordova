...
var cardList = [
    ...
    new ColinWielgaCards.QualOutcomeCard("{5AD1139D-FA32-4A2A-B678-C3466081E7B5}", "ATLANTS", "ALIEN ARTIFACT", "Chemical breath that puts lifeforms to sleep. ", "20%","40%"),
    new ColinWielgaCards.QualOutcomeCard("{4DD4A14E-9454-4536-97C2-578FE294E57A}", "COLD WEREBEAR", "ALIEN ARTIFACT", "Slowing effect on your attacks, but you always have lowest initiative. ", "6%","40%"),
    ...
    new ColinWielgaCards.QualOutcomeCard("{4EEC15F2-21BB-4821-86FD-5AD9B2C2131D}", "ATLANTACE", "ALIEN ARTIFACT", "Every time you fail using this gadget, roll 1d10, if you roll a number lower than the number of failures you've had, you are horribly maimed. ", "20%","40%"),
    new ColinWielgaCards.QualOutcomeCard("{4EA9C4D1-87B9-4B60-8487-4EBE2620938B}", "HAUNTED", "ALIEN ARTIFACT", "Any time you try and fail to use alien technology; or if alien technology is successfully employed against you, increase the Cloud of Uncertainty.", "20%","45%"),
    ...
    new ColinWielgaCards.QualOutcomeCard("{0A20CEF3-1EC2-4C28-9030-F58E9B3869E2}", "ATLANTA", "ALIEN ARTIFACT", "The blood boiler, you may draw up to 4 random uncertainty cards. ", "20%","50%"),
    ...
    new ColinWielgaCards.QualOutcomeCard("{018F6F3C-B8E2-4C26-9468-DE1EA9968EB8}", "MECHANICAL VIPER APPENDAGE", "SPY GADGET", "A spring loaded device. ", "6%","45%"),
    new ColinWielgaCards.QualOutcomeCard("{F76BC99A-FEFF-40E1-81AB-09CC25D979E0}", "ATLATL", "SPY GADGET", "+10% success for throwing grappling hooks/harpoons. ", "7%","40%"),
    ...
    new ColinWielgaCards.QualOutcomeCard("{7A554276-8F9F-422F-AAC2-E3CA2B575788}", "CATALYST", "SPY GADGET", "A quick acting DNA comparison testing device. ", "8%","36%"),
    ...
    new ColinWielgaCards.QualOutcomeCard("{15D3D15F-6025-4488-AB1B-85C0E6EF1684}", "EPHEMERAL", "SPY GADGET", "You can see ghosts. ", "30%","35%"),
